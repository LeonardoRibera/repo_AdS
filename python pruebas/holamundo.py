...
# server = 'DESKTOP-QB22C4J\SQLEXPRESS'  # Por ejemplo, 'localhost' o '192.168.1.1'
...
#             if columns:
#                 print(tabulate(columns, headers=["Nombre de Columna", "Tipo de Dato"], tablefmt="grid"))
#             else:
